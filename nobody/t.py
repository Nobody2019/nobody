...
class Job:
    def __init__(self, schedule, job_func, scheduler):
...
class Schedule(object):
    ...
    * a quantity of `time units` defined by `interval`
    ...
    def __init__(self, interval, scheduler=None):
        ...
        self.prev_time = None  # datetime of the last run
        self.next_time = None  # datetime of the next run
    ...
    def __lt__(self, other):
        ...
        run next.
        """
        return self.next_time < other.next_run
    ...
    def __repr__(self):
        ...
        timestats = '(last run: %s, next run: %s)' % (
            format_time(self.prev_time), format_time(self.next_time))
    ...
    def should_run(self):
        ...
        """
        return datetime.datetime.now() >= self.next_time
    ...
    def _schedule_next_run(self):
        ...
        self.next_time = datetime.datetime.now() + self.period
        if self.start_day is not None:
            ...
            days_ahead = weekday - self.next_time.weekday()
            if days_ahead <= 0:  # Target day already happened this week
                days_ahead += 7
            self.next_time += datetime.timedelta(days_ahead) - self.period
        if self.at_time is not None:
            if (self.unit not in ('days', 'hours', 'minutes')
            ...
            self.next_time = self.next_time.replace(**kwargs)
            ...
            if not self.prev_time:
                ...
                if (self.unit == 'days' and self.at_time > now.time() and
                    ...
                    self.next_time = self.next_time - datetime.timedelta(hours=1)
                elif self.unit == 'minutes' \
                        and self.at_time.second > now.second:
        ...
        if self.start_day is not None and self.at_time is not None:
            ...
            if (self.next_time - datetime.datetime.now()).days >= 7:
